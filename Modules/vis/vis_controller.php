  ...
  function vis_controller()
  {
    ...
    */
    ...
    $visualisations = array(
      'rawdata'=> array('options'=>array(array('feedid',0),array('fill',7,0),array('units',5,'W'))),
      'bargraph'=> array('options'=>array(array('feedid',0))),
      'histgraph'=> array('options'=>array(array('feedid',1),array('barwidth',7,50),array('start',7,0),array('end',7,0))),
    ...
    if ($route->format =='html')
    {
        ...
        if ($route->action == "auto")
        {
            ...
            if ($datatype == 0) $route->action = 'rawdata';
            if ($datatype == 1) $route->action = 'histgraph';
        }
