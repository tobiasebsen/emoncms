...
var feed = {
  ...
  'create':function(name,type,prop)
  {
    var result = {};
    $.ajax({ url: path+"feed/create.json", data: "name="+name+"&type="+type+"&prop="+prop, dataType: 'json', async: false, success: function(data) {result = data;} });
    return result;
  },
